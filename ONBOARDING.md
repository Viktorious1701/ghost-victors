...
| **4 — Victors Platform (Supabase)** | P4a backend (`runs` + storage + `submit` fn) ✅ · P4b client fetch/cache/offline + Bot badges + submit ✅ · P6 macro seeding ("Bot Vikkie") ⏳ next | 🔨 P4a+P4b done; P6 next (design: `docs/plans/victors-platform.design.md`) |
